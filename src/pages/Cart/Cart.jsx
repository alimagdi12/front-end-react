                ...
                >
                  <Grid container spacing={2} alignItems="center">
                    <Grid item xs={12} md={2} height={"100px"}>
                      <Avatar
                        variant="square"
                        src={`${item.productId?.imagesUrl.images[0]}`}
                        sx={{
                          width: "100%",
                          height: "100%",
                          borderRadius: "5px",
            ...
            <Grid item xs={12} md={4}>
              ...
              >
                ...
                >
                  ...
                  <Typography>{totalPrice} EGP</Typography>
                </Box>
                <Box
                  sx={{
                    display: "flex",
                ...
                >
                  ...
                  <Typography>{totalCash} EGP</Typography>
                </Box>
              </Box>
              {cartItems.length !== 0 && (
                <Button
